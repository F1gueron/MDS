...
while hrefs:
    ...
    if href not in visited:
        ...
        try:
            ...
            #page_text += driver.find_element(By.CLASS_NAME, "posttitle").text # Para buscar en el cuerpo del post y en el título
...
# Regex menos amplia y solo cuerpo del post = 271 -> Este
# Regex más amplia y solo cuerpo del post = 278 -> no lo sabemos aun
# Regex más amplia y cuerpo del post + título = 278 -> no lo sabemos aun
# Regex menos amplia y cuerpo del post + título = 271 -> no lo sabemos aun
# En los títulos no hay URJC, por lo que no afecta a los resultados